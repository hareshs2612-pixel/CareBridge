...
export const SEED_DIAGNOSTIC_TESTS = [
  {
    id: 'test-cbc',
    code: '58410-2',
  ...
  },
  {
    ...
    preparationInstructions: 'Mandatory 8-10 hours overnight fasting required. Water permitted.',
    costInr: 120,
    isAvailable: true
  },
  {
    id: 'test-hba1c',
    code: '4548-4',
    name: 'Glycated Hemoglobin (HbA1c) HPLC Assay',
    category: 'biochemistry',
    turnaroundHours: 4,
    sampleType: 'Whole Blood (EDTA)',
  ...
  },
  {
    ...
    preparationInstructions: 'Remove metallic items and jewelry from chest and neck area.',
    costInr: 450,
    isAvailable: true
  },
  {
    id: 'test-usg-abdomen',
    code: '24627-2',
    name: 'Abdominal & Pelvic Ultrasound (USG)',
    category: 'radiology',
    turnaroundHours: 3,
    sampleType: 'Ultrasound Imaging',
    preparationInstructions: 'Full bladder required for pelvic scan; 4 hours fasting for upper abdomen.',
    costInr: 1200,
    isAvailable: true
  },
  {
    ...
    category: 'cardiology',
    turnaroundHours: 1,
    sampleType: 'Electrophysiological Trace',
    preparationInstructions: 'Rest comfortably for 5 minutes prior to recording.',
    costInr: 250,
    isAvailable: true
  }
];

export const SEED_DIAGNOSTIC_ORDERS = [
  {
    id: 'diag-ord-101',
    patientId: 'pat-ramesh',
    patientName: 'Ramesh Kumar',
    patientPhone: '+919415012345',
    doctorId: 'doc-sharma',
    doctorName: 'Dr. Anita Sharma',
    ...
    clinicalIndication: 'Routine quarterly surveillance for Type 2 Diabetes Mellitus with Stage 1 Essential Hypertension.',
    status: 'RESULT_AVAILABLE',
    scheduledSlot: '2026-09-22T08:30:00Z',
    scheduledFacilityId: 'hosp-apex',
    sampleCollectedAt: '2026-09-22T08:45:00Z',
    results: [
      {
    ...
    reportSummary: 'Sub-optimal glycemic control (HbA1c 7.4%) with borderline atherogenic dyslipidemia. Fasting glucose elevated at 142 mg/dL.',
    abnormalFlagCount: 4,
    criticalFlagCount: 0,
    doctorReviewNotes: '',
    reviewedByDoctorId: '',
    reviewedAt: '',
    linkedRecordId: 'rec-ramesh-1',
    createdAt: '2026-09-21T07:30:00Z',
    updatedAt: '2026-09-21T11:15:00Z',
    demoNotice: 'Demo laboratory report generated for clinical evaluation.'
  },
  {
    id: 'diag-ord-102',
    patientId: 'pat-sunita',
    patientName: 'Sunita Devi',
    patientPhone: '+919415067890',
    doctorId: 'doc-sharma',
    doctorName: 'Dr. Anita Sharma',
    facilityId: 'hosp-chc-rampur',
    ...
    tests: [
      ...
      },
      {
        id: 'test-ecg',
        code: '11524-6',
        name: '12-Lead Resting Electrocardiogram',
        category: 'cardiology',
        turnaroundHours: 1,
        costInr: 250,
        isAvailable: true
    ...
    clinicalIndication: 'Antenatal wellness review and evaluation for transient lightheadedness.',
    status: 'REVIEWED',
    scheduledSlot: '2026-09-18T10:00:00Z',
    scheduledFacilityId: 'hosp-chc-rampur',
    sampleCollectedAt: '2026-09-18T10:15:00Z',
    results: [
      {
      ...
      },
      {
        ...
        value: '2.4',
        unit: 'Lakhs/cumm',
        referenceRange: '1.5 - 4.5 Lakhs/cumm',
        isAbnormal: false,
        criticalFlag: false
      },
      {
        parameterName: 'Resting Rhythm (ECG)',
        value: 'Normal Sinus Rhythm (HR 76 bpm)',
        unit: 'Trace',
    ...
    reportSummary: 'Mild microcytic hypochromic anemia (Hb 10.8 g/dL) consistent with second trimester pregnancy hemodilution. ECG unremarkable.',
    abnormalFlagCount: 1,
    criticalFlagCount: 0,
    doctorReviewNotes: 'Reviewed in OPD. Mild gestational anemia noted. Prescribed Ferrous Ascorbate 100mg with Folic Acid once daily after dinner.',
    reviewedByDoctorId: 'doc-sharma',
    reviewedAt: '2026-09-18T14:30:00Z',
    linkedRecordId: 'rec-sunita-1',
...
export const SEED_REFERRALS = [
  {
    ...
    patientAge: 53,
    patientGender: 'male',
    referringDoctorId: 'doc-sharma',
    referringDoctorName: 'Dr. Anita Sharma',
    referringFacilityId: 'hosp-chc-rampur',
    referringFacilityName: 'Community Health Centre (CHC) Rampur',
    destinationFacilityId: 'hosp-apex',
    destinationFacilityName: 'CareBridge Apex Hospital & Heart Centre',
    specialtyRequired: 'Cardiology & Preventative Nephrology',
    priority: 'priority',
    clinicalReason: 'Uncontrolled Type 2 Diabetes (HbA1c 7.4%) with stage 1 hypertension. Specialist workup for early diabetic nephropathy and cardiovascular risk stratification.',
    provisionalDiagnosis: 'Type 2 Diabetes Mellitus with Essential Hypertension',
    attachedRecordIds: ['rec-ramesh-1', 'rec-ramesh-2'],
    status: 'ACCEPTED',
    timeline: [
      {
        id: 'rtl-1',
        ...
        actorRole: 'doctor',
        notes: 'Referral draft prepared following review of recent fasting plasma glucose levels.'
      },
      {
        id: 'rtl-2',
        status: 'SENT',
        ...
        actorName: 'Dr. Anita Sharma',
        actorRole: 'doctor',
        notes: 'Dispatched securely to CareBridge Apex Hospital Central Triage desk.'
      },
      {
        id: 'rtl-3',
        status: 'RECEIVED',
        ...
        actorId: 'admin-sunil',
        actorName: 'Triage Desk Apex',
        actorRole: 'admin',
        notes: 'Referral intake acknowledged. Clinical record documents attached.'
      },
      {
        id: 'rtl-4',
        status: 'ACCEPTED',
        ...
        actorRole: 'doctor',
        notes: 'Accepted for Cardiology / Chronic Care OPD. Scheduling consultation slot.'
      }
    ],
    scheduledAppointmentId: 'apt-corporate-01',
    scheduledDate: '2026-09-24T10:30:00Z',
    destinationDoctorId: 'doc-verma',
    destinationDoctorName: 'Dr. Rajesh Verma',
    feedbackReport: '',
  ...
  },
  {
    ...
    referringFacilityId: 'hosp-chc-rampur',
    referringFacilityName: 'Community Health Centre (CHC) Rampur',
    destinationFacilityId: 'hosp-dist-sitapur',
    destinationFacilityName: 'District Hospital Sitapur',
    specialtyRequired: 'Obstetrics & High-Risk Pregnancy',
    priority: 'urgent',
    clinicalReason: 'Third trimester antenatal consultation; anomaly scan and maternal hemoglobin monitoring.',
    provisionalDiagnosis: 'Gestational Care with Mild Microcytic Anemia',
    attachedRecordIds: ['rec-sunita-1'],
    ...
    timeline: [
      {
        ...
        actorName: 'Dr. Anita Sharma',
        actorRole: 'doctor',
        notes: 'Dispatched to District Hospital Antenatal Unit.'
      },
      {
        id: 'rtl-11',
        status: 'ACCEPTED',
        ...
        actorName: 'Dr. Rajesh Verma',
        actorRole: 'doctor',
        notes: 'Accepted for OB/GYN Special Clinic.'
      },
      {
        id: 'rtl-12',
        status: 'APPOINTMENT_SCHEDULED',
        ...
        actorId: 'admin-sunil',
        actorName: 'OPD Scheduling',
        actorRole: 'admin',
        notes: 'Appointment confirmed for Sep 28 at 10:00 AM.'
      }
    ],
    scheduledAppointmentId: 'apt-sunita-dist',
...
export const SEED_CARE_PLANS = [
  {
    ...
    doctorId: 'doc-sharma',
    doctorName: 'Dr. Anita Sharma',
    primaryCondition: 'Type 2 Diabetes Mellitus & Essential Hypertension',
    riskTier: 'high',
    status: 'due_soon',
    startDate: '2026-08-15',
    targetReviewDate: '2026-11-15',
    tasks: [
      {
        id: 'cpt-1',
        title: 'Morning Telma 40mg Adherence',
        description: 'Take 1 tablet Telmisartan 40mg every morning after breakfast with water.',
        type: 'medication_adherence',
        dueDate: 'Daily (Ongoing)',
        completed: true,
        completedAt: '2026-09-21T08:00:00Z',
        notes: 'Patient reports steady compliance.'
      },
      {
        id: 'cpt-2',
        title: 'Glycomet 500 SR Twice Daily',
        description: 'Take 1 tablet Metformin 500mg with breakfast and 1 with dinner.',
        type: 'medication_adherence',
        dueDate: 'Daily (Ongoing)',
        completed: true,
        completedAt: '2026-09-21T08:00:00Z',
        notes: 'No gastric distress reported.'
      },
      {
        id: 'cpt-3',
        title: 'Fasting Plasma Glucose & HbA1c Lab Panel',
        description: 'Quarterly venous blood sample at CareBridge Apex Pathology Lab.',
        type: 'diagnostic_test',
        dueDate: '2026-09-22',
        completed: true,
        completedAt: '2026-09-22T08:45:00Z',
        notes: 'Sample processed; results indicate HbA1c 7.4%.'
      },
      {
        id: 'cpt-4',
        title: 'Specialist Cardiology Consultation (In-Person)',
        description: 'In-person review at CareBridge Apex Hospital with Dr. Anita Sharma.',
        type: 'doctor_visit',
        dueDate: '2026-09-24',
        completed: false,
        notes: 'Token CB-14 confirmed.'
      },
      {
        id: 'cpt-5',
        title: 'Bi-weekly Home Blood Pressure Log',
        description: 'Record sitting BP reading before breakfast twice weekly.',
        type: 'vitals_log',
        dueDate: '2026-09-25',
        completed: false,
    ...
    diagnosticDue: 'Lipid repeat in 3 months',
    nextAppointmentDue: '2026-09-24T10:30:00Z',
    lastClinicianContact: '2026-09-20T10:00:00Z',
    escalationCount: 0,
    notes: 'Patient shows high compliance with morning antihypertensive but requires active dietary sodium reinforcement.',
    createdAt: '2026-08-15T11:45:00Z',
  ...
  },
  {
    ...
    doctorId: 'doc-sharma',
    doctorName: 'Dr. Anita Sharma',
    primaryCondition: 'Antenatal Gestational Care & Maternal Anemia Management',
    riskTier: 'moderate',
    status: 'on_track',
    startDate: '2026-09-01',
    targetReviewDate: '2026-10-15',
    tasks: [
      {
        id: 'cpt-10',
        title: 'Ferrous Ascorbate & Folic Acid Daily',
        description: 'Take 1 tablet every evening after food with citrus juice/water.',
        type: 'medication_adherence',
        dueDate: 'Daily (Ongoing)',
        completed: true,
        completedAt: '2026-09-20T20:00:00Z',
        notes: 'Adhering well.'
      },
      {
        id: 'cpt-11',
        title: 'District Hospital Anomaly Ultrasound',
        description: 'Targeted ultrasound scan for fetal anatomy and growth parameters.',
        type: 'diagnostic_test',
        dueDate: '2026-09-28',
        completed: false,
        notes: 'Scheduled for Sep 28 at District Hospital.'
      },
      {
        id: 'cpt-12',
        title: 'Frontline Worker Antenatal Home Check',
        description: 'Vitals and maternal wellness check by Rekha Devi (ASHA).',
        type: 'vitals_log',
        dueDate: '2026-09-26',
        completed: false,
        notes: 'ASHA home visit scheduled.'
      }
    ],
    medicationReviewStatus: 'current',
    diagnosticDue: 'Repeat CBC for Hemoglobin in 4 weeks',
    nextAppointmentDue: '2026-09-28T10:00:00Z',
    lastClinicianContact: '2026-09-18T14:30:00Z',
    escalationCount: 0,
    notes: 'Fetal growth steady. Hemoglobin to be tracked every month.',
    createdAt: '2026-09-01T10:00:00Z',
    updatedAt: '2026-09-20T20:00:00Z'
  }
];

export const SEED_FACILITY_METRICS = [
  {
    facilityId: 'hosp-apex',
    facilityName: 'CareBridge Apex Hospital & Heart Centre',
    opdQueueCount: 28,
    averageConsultationWaitMinutes: 18,
    pendingReferralsCount: 4,
    completedReferralsRatePercent: 94.2,
    diagnosticTurnaroundAverageHours: 3.2,
    pharmacyFulfillmentRatePercent: 98.6,
    overdueFollowUpsCount: 2,
    criticalCareBedsOccupied: 15,
    criticalCareBedsTotal: 20,
    lastUpdated: '2026-09-21T14:00:00Z',
    demoNotice: 'Demo operational quality metrics. Refreshed continuously.'
  },
  {
    facilityId: 'hosp-chc-rampur',
    facilityName: 'Community Health Centre (CHC) Rampur',
    opdQueueCount: 14,
    averageConsultationWaitMinutes: 12,
    pendingReferralsCount: 2,
    completedReferralsRatePercent: 88.5,
    diagnosticTurnaroundAverageHours: 4.8,
    pharmacyFulfillmentRatePercent: 91.2,
    overdueFollowUpsCount: 5,
    criticalCareBedsOccupied: 2,
    criticalCareBedsTotal: 4,
    lastUpdated: '2026-09-21T14:00:00Z',
    demoNotice: 'Demo operational quality metrics. Refreshed continuously.'
  },
  {
    facilityId: 'hosp-dist-sitapur',
    facilityName: 'District Hospital Sitapur',
    opdQueueCount: 46,
    averageConsultationWaitMinutes: 34,
    pendingReferralsCount: 7,
    completedReferralsRatePercent: 82.0,
    diagnosticTurnaroundAverageHours: 5.6,
    pharmacyFulfillmentRatePercent: 89.4,
    overdueFollowUpsCount: 8,
    criticalCareBedsOccupied: 11,
    criticalCareBedsTotal: 12,
    lastUpdated: '2026-09-21T14:00:00Z',
    demoNotice: 'Demo operational quality metrics. Refreshed continuously.'
  }
];
